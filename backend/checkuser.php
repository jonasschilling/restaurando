			...
			if($finalresult == $password){
				if($type == 1){
					...
					<?php
						...
						?>
							<script type="text/javascript" language="Javascript"> 
								alert(unescape("Sie sind kein Administrator%21 Bitte %FCberpr%FCfen Sie Ihre Eingaben."));
								history.go(-1);
							</script>
						<?php
					}
					...
					<?php
						...
						?>
							<script type="text/javascript" language="Javascript"> 
								alert(unescape("Sie sind kein Restaurantbesitzer%21 Bitte %FCberpr%FCfen Sie Ihre Eingaben."));
								history.go(-1);
							</script>
						<?php
					}
